  ...
  return ( 
    <div className='bg-gray-800 text-white scroll-smooth' ><div className=""></div>
      ...
      <div className='bg-gray-800 text-white max-w-[80%] mx-auto'>
        ...
        <m.div viewport={{ once: true }} id='about'>
          <About/>
        </m.div>
        ...
        <m.div viewport={{ once: true }} className=' min-h-screen' id='portfolio' > 

          <m.p viewport={{ once: true }} initial={{opacity:0, x:"-100%"}} whileInView={{opacity:1, x:"0"}}  transition={{duration:1.4, ease:'easeInOut'}} className='lg:text-8xl md:text-5xl text-3xl uppercase text-center pb-16 text-orange-500 pt-32 lg:pt-52 ' >check out my work</m.p>  
          <m.h1 viewport={{ once: true }} initial={{opacity:0, x:"-100%"}} whileInView={{opacity:1, x:"0"}}  transition={{duration:1.4, ease:'easeInOut'}} className='w-full text-center lg:text-3xl uppercase'>Web Projects</m.h1>
          <div className='xl:flex gap-10 sm:my-5 lg:pt-4'>
          <m.div viewport={{ once: true }} initial={{opacity:0, x:"-100%"}} whileInView={{opacity:1, x:"0"}}  transition={{duration:1.4, ease:'easeInOut'}}>
          ...
          <m.div viewport={{ once: true }} initial={{opacity:0, x:"-100%"}} whileInView={{opacity:1, x:"0"}}  transition={{duration:1.2, ease:'easeInOut'}}>
          ...
          <m.div viewport={{ once: true }} initial={{opacity:0, x:"-100%"}} whileInView={{opacity:1, x:"0"}}  transition={{duration:1, ease:'easeInOut'}}>
        ...
        <m.h1 viewport={{ once: true }} initial={{opacity:0, x:"-100%"}} whileInView={{opacity:1, x:"0"}}  transition={{duration:1.4, ease:'easeInOut'}} className='w-full text-center lg:text-3xl uppercase'>Android Projects</m.h1>
        <div className='lg:flex gap-10 justify-center'>
        <m.div viewport={{ once: true }} className='' initial={{opacity:0, x:"-100%"}} whileInView={{opacity:1, x:"0"}}  transition={{duration:1, ease:'easeInOut'}}>
        ...
        <m.section viewport={{ once: true }} id='contact' className='bg-gray-800 min-h-screen lg:pt-20 pt-1 pb-3' initial={{ opacity:0, x:"-100%"}} whileInView={{ opacity:1, x:"0"}}  transition={{duration:1.4 , ease: "easeIn"}}>
          <ContactUs/>
        </m.section>
