...
const ContactUs = () => {
  ...
  return (
    <form ref={form} onSubmit={sendEmail} className="mt-[200px] mb-[100px] md:max-w-xs px-[25px] bg-white text-black rounded-lg lg:my-[200px] flex flex-col mx-auto leading-10 max-w-[1000px]">
      <h1 className='text-3xl text-center pt-10'>Contact Me</h1>
      <label>Name</label>
      ...
      <input type="submit" value="Send" className='m-10 bg-orange-600 w-20 mx-auto rounded-lg text-lg h-10 mb-10 text-white'/>
    </form>
  );
};
