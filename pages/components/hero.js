...
function Hero(){
    return(
    <m.section className='hero min-h-screen uppercase font-mono ease-in duration-200 mt-[-40px]' id="hero"  initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration: 0.75}}> 
        <div className=''>
